...
- Name: 04-timetable.spec.js >> TS_TIMETABLE: Timetable Generation >> TC_TT_03: Switch Timetable Views
- Location: tests/e2e/04-timetable.spec.js:41:3
...
Locator: locator('th:has-text("Period")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('th:has-text("Period")').first()
